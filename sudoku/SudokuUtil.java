...
public final class SudokuUtil {
     ...
     * @return a formatted text view of the Sudoku board.
     */
    public static String formatBoard_AL(ArrayList<Integer>[][] board) {
        String r = "";
        String hline = "";
//        int len[][] = new int[10][3];
//        for (int i = 0; i < 9; i++) {
//            for (int j = 0; j < 9; j++) {
//                len[i][j / 3] += board[i][j].size();
//            }
//        }
//
//        for (int i = 0; i < 3; i++) {
...
//        }
        ...
        for (int i = 0; i < board.length; i++) {
            ...
            for (int j = 0; j < board[i].length; j++) {
                if (j > 0 && j % 3 == 0) {
//                    for (int k = len[i][j/3]; k < len[9][j/3]; k++) {
//                        r += " ";
//                    }
                    r += " | ";
                }
                r += readList(board[i][j]) + " ";
            }
            r += "\n";
        }
        return r;
    ...
    public static String readList (ArrayList unit){
        String r = "";
        for (int i = 0;i< unit.size();i++){
            r+=unit.get(i).toString();
        }
        return r;
    }
    /**
